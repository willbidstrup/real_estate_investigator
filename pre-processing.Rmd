...
Tabula is amazing but still requires a manual intervention, I tried to get something happening more automaically with tm package but couldn't get it to work in a timely manner.  
```{r}
